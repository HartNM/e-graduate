//พิมพ์ใบรายชื่อผู้มีสิทธิสอบโครงร่างวิทยานิพนธ์/การค้นคว้าอิสระ
...
const PrintExam = () => {
	...
	const handleExport = () => {
		const mainHeader = [[`รายชื่อผู้มีสิทธิสอบโครงร่างวิทยานิพนธ์/การค้นคว้าอิสระ ปีการศึกษา ${selectedTerm}`]];
		...
		const fileName = `รายชื่อผู้มีสิทธิสอบโครงร่างวิทยานิพนธ์_การค้นคว้าอิสระ_${selectedTerm}.xlsx`;
		...
		<Box>
			...
			<Group justify="space-between">
				...
				<Group>
					...
					<PdfPrintExam data={filteredData} typeRQ={"3"} />
				</Group>
			</Group>
