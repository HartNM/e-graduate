//พิมพ์ใบรายชื่อผู้มีสิทธิสอบวิทยานิพนธ์/การค้นคว้าอิสระ
...
const PrintExam = () => {
	...
	const handleExport = () => {
		const mainHeader = [[`รายชื่อผู้มีสิทธิสอบวิทยานิพนธ์/การค้นคว้าอิสระ ปีการศึกษา ${selectedTerm}`]];
		...
		const fileName = `รายชื่อผู้มีสิทธิสอบวิทยานิพนธ์_การค้นคว้าอิสระ_${selectedTerm}.xlsx`;
