...
const menu = [
	...
	{ label: `คำร้องขอสอบโครงร่างการวิจัย`, icon: IconReport, links: "/chairpersons/RequestThesisProposal" },
	{ label: `คำร้องขอเลื่อนสอบโครงร่างการวิจัย`, icon: IconCalendarClock, links: "/chairpersons/PostponeProposalExam" },
	{ label: "รายงานตรวจสอบโครงร่างการวิจัย", icon: IconSearch, links: "/chairpersons/PlagiarismProposal" },
	{ label: `คำร้องขอสอบการวิจัย`, icon: IconReport, links: "/chairpersons/RequestThesisDefense" },
	{ label: `คำร้องขอเลื่อนสอบการวิจัย`, icon: IconCalendarClock, links: "/chairpersons/PostponeDefenseExam" },
	{ label: "รายงานตรวจสอบการวิจัย", icon: IconSearch, links: "/chairpersons/PlagiarismDefense" },
