...
const ModalPay = ({ opened, onClose, selectedRow, handlePay, MoneyRegis, stop_date }) => {
	...
	const paymentLink = selectedRow ? `${API_BASE_URL}/payment/redirect?student_id=${selectedRow.student_id}&amount=${MoneyRegis}&endDate=${stop_date}&urlredirect=${returnUrl}` : "#";
					...
					<a href={paymentLink} style={{ textDecoration: "none" }}>
						<Stack align="center" gap="md">
							...
							<Group justify="center" gap="md">
								<Image src={`${API_BASE_URL}/payment/image/Visa_Mastercard_jcb.jpg`} alt="payment credit" h={30} w="auto" />
								<Image src={`${API_BASE_URL}/payment/image/logo_ktb_next.png`} alt="krungthai Next" h={35} w="auto" />
								<Image src={`${API_BASE_URL}/payment/image/promtpay1.png`} alt="promtpay" h={30} w="auto" />
							</Group>
